...
class SqueezeDetPlus(ModelSkeleton):
  ...
  def _add_forward_graph(self):
    ...
    conv1 = self._conv_layer(
        'conv1', self.image_input, filters=48, size=7, stride=2,
        padding='VALID', freeze=True)
    pool1 = self._pooling_layer(
        'pool1', conv1, size=3, stride=2, padding='VALID')

    fire2 = self._fire_layer(
        'fire2', pool1, s1x1=32, e1x1=64, e3x3=64, freeze=False)
    fire3 = self._fire_layer(
        'fire3', fire2, s1x1=32, e1x1=64, e3x3=64, freeze=False)
    fire4 = self._fire_layer(
        'fire4', fire3, s1x1=48, e1x1=128, e3x3=128, freeze=False)
    pool4 = self._pooling_layer(
        'pool4', fire4, size=3, stride=2, padding='VALID')

    fire5 = self._fire_layer(
        'fire5', pool4, s1x1=48, e1x1=128, e3x3=128, freeze=False)
    fire6 = self._fire_layer(
        'fire6', fire5, s1x1=64, e1x1=192, e3x3=192, freeze=False)
    fire7 = self._fire_layer(
        'fire7', fire6, s1x1=96, e1x1=192, e3x3=192, freeze=False)
    fire8 = self._fire_layer(
        'fire8', fire7, s1x1=96, e1x1=256, e3x3=256, freeze=False)
    ...
    fire10 = self._fire_layer(
        'fire10', fire9, s1x1=96, e1x1=256, e3x3=256, freeze=False)
    fire11 = self._fire_layer(
        'fire11', fire10, s1x1=96, e1x1=256, e3x3=256, freeze=False)
